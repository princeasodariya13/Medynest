				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" id="mainTitle-h1">User | Change Password</h1>
																	</div>
            ...
            <div class="custom-form-body">
                ...
                <form role="form" name="chngpwd" method="post" onsubmit="return valid();">
                    ...
                    <div class="custom-form-group">
                        ...
                        <input type="password" name="cpass" class="custom-input" id="currentPassword" placeholder="Enter Current Password" required>
                    </div>

                    <!-- New Password -->
                    <div class="custom-form-group">
                        <label for="newPassword" class="custom-label required">New Password</label>
                        <input type="password" name="npass" class="custom-input" id="newPassword" placeholder="New Password" required>
                    </div>

                    <!-- Confirm Password -->
                    <div class="custom-form-group">
                        <label for="confirmPassword" class="custom-label required">Confirm Password</label>
                        <input type="password" name="cfpass" class="custom-input" id="confirmPassword" placeholder="Confirm Password" required>
                    </div>
