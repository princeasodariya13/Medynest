				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" id="mainTitle-h1">Admin | Edit Doctor Specialization</h1>
																	</div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="custom-form-container">
                        <div class="custom-form-header">
                            <h5 class="custom-form-title">Edit Doctor Specialization</h5>
                        </div>
                        <div class="custom-form-body">
                            <p style="color:red; margin-bottom: 20px; padding: 10px; background: rgba(255, 71, 87, 0.1); border-radius: 6px; border-left: 3px solid #ff4757;">
                            ...
                            <form role="form" name="dcotorspcl" method="post">
                                <div class="custom-form-group">
                                    <label for="exampleInputEmail1" class="custom-label">
                                    ...
                                    {														
                                    ?>
                                    <input type="text" name="doctorspecilization" class="custom-input" value="<?php echo $row['specilization'];?>">
                                    <?php } ?>
                                </div>
